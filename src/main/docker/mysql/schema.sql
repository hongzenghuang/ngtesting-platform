...
-- ----------------------------
--  Table structure for `IsuAttachment`
-- ----------------------------
...
-- ----------------------------
DROP TABLE IF EXISTS `IsuCustomFieldProjectRelation`;
CREATE TABLE `IsuCustomFieldProjectRelation` (
...
-- ----------------------------
DROP TABLE IF EXISTS `IsuStatusTransition`;
CREATE TABLE `IsuStatusTransition` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `SysRolePrivilegeRelation`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `SysRoleUserRelation`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `TstDocument`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `TstOrgPrivilegeDefine`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `TstOrgRole`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `TstProjectRole`
-- ----------------------------
...
-- ----------------------------
--  Procedure structure for `add_cases_to_task`
-- ----------------------------
DROP PROCEDURE IF EXISTS `add_cases_to_task`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `add_cases_to_task_by_suites`
-- ----------------------------
DROP PROCEDURE IF EXISTS `add_cases_to_task_by_suites`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `add_case_to_task`
-- ----------------------------
DROP PROCEDURE IF EXISTS `add_case_to_task`;
delimiter ;;
...
BEGIN
    ...
    open cur;
        read_loop:loop
            fetch cur into _id, _name, _is_leaf, _p_id, _ordr;
            if done then  
		leave read_loop; 
            end if;
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `chart_design_progress_by_project`(IN project_id BIGINT, IN project_type VARCHAR(100), IN numb BIGINT)
BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `chart_execution_process_by_plan`(IN _planId BIGINT, IN _numb BIGINT)
BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `chart_execution_process_by_plan_user`(IN _planId BIGINT, IN _numb BIGINT)
BEGIN
...
-- ----------------------------
--  Procedure structure for `chart_execution_process_by_project`
-- ----------------------------
DROP PROCEDURE IF EXISTS `chart_execution_process_by_project`;
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `chart_execution_process_by_project`(IN project_id BIGINT, IN project_type VARCHAR(100), IN numb BIGINT)
BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `chart_execution_result_by_plan`(IN _planId BIGINT)
BEGIN
...
-- ----------------------------
--  Procedure structure for `close_plan_if_all_task_closed`
-- ----------------------------
DROP PROCEDURE IF EXISTS `close_plan_if_all_task_closed`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `delete_case_and_its_children`
-- ----------------------------
DROP PROCEDURE IF EXISTS `delete_case_and_its_children`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `delete_case_in_task_and_its_children`
-- ----------------------------
DROP PROCEDURE IF EXISTS `delete_case_in_task_and_its_children`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `delete_dict`
-- ----------------------------
DROP PROCEDURE IF EXISTS `delete_dict`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `fix_is_leaf_issue_in_task`
-- ----------------------------
DROP PROCEDURE IF EXISTS `fix_is_leaf_issue_in_task`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `gen_project_access_history`
-- ----------------------------
DROP PROCEDURE IF EXISTS `gen_project_access_history`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `init_nums`
-- ----------------------------
DROP PROCEDURE IF EXISTS `init_nums`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `init_old_case_data`
-- ----------------------------
DROP PROCEDURE IF EXISTS `init_old_case_data`;
delimiter ;;
...
insert into TstOrgGroup (name, orgId, disabled, deleted, createTime) values('所有人', org_id, false, false, NOW());
...
-- ----------------------------
--  Procedure structure for `update_case_parent_if_needed`
-- ----------------------------
DROP PROCEDURE IF EXISTS `update_case_parent_if_needed`;
delimiter ;;
...
-- ----------------------------
--  Procedure structure for `user_not_in_project`
-- ----------------------------
DROP PROCEDURE IF EXISTS `user_not_in_project`;
delimiter ;;
...
-- ----------------------------
--  Function structure for `fn_calc_length`
-- ----------------------------
DROP FUNCTION IF EXISTS `fn_calc_length`;
delimiter ;;
